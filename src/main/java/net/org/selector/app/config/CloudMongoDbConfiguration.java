...
import net.org.selector.app.config.oauth2.OAuth2AuthenticationReadConverter;
import net.org.selector.app.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("net.org.selector.app.repository")
